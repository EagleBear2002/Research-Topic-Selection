...
该研究建立了一个新的评估标准，结合人类专家和 GPT-4 的分类，评估了 GPT 能力美国劳动力对各职业任务的影响，用暴露值（Exposure）表示这一影响。主要结论包括：
...
<!--
我以上的部分表面上是在批判 AI 研究中的乱象，并且制造了 AI 会代替工作的焦虑。
...
这是一个纯主观的感受，它体现在你是否愿意沉浸其中甚至废寝忘食，能够连续几个月把大量的时间精力投入到同一个问题当中并且乐在其中。
如果你能做到这点，那么你的研究是否有客观的现实意义就不再重要了。
正如马克思在《哥达纲领批判》中的预言，“在共产主义社会高级阶段，劳动已经不仅仅是谋生的手段，而是本身成了生活的第一需要”。
年前我和智软院党委武书记讨论到工作意义的问题。武书记认为，马克思所描述的这种社会形态并非遥不可及，甚至在很多行业已经实现。
